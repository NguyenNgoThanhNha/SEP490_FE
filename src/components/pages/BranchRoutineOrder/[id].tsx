...
const UserRoutineDetailPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const routineInfoResponse = await routineService.getRoutineByUserId( Number(routineId, userId));
...
export default UserRoutineDetailPage;
