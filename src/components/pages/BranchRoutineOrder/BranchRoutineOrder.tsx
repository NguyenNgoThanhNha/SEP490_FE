...
const BranchRoutineOrder = () => {
  ...
  const handleEdit = (orderId: number, userRoutineId: number) => {
    navigate(`/branch-routine-order/${orderId}/${userRoutineId}`);
  };
          ...
          actions={(row) => (
            <>
              <button
                ...
                onClick={() => handleEdit(row.orderId as number, row.userRoutineId as number)} // Truyền orderId và userRoutineId
              >
