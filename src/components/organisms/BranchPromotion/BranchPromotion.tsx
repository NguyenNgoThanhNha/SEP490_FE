...
// import { BranchPromotionSchema, BranchPromotionType } from "@/schemas/branchPromotionSchema";

// interface BranchPromotionFormProps {
//   mode: "create" | "update";
//   initialData?: BranchPromotionType;
//   onSubmit: (data: BranchPromotionType) => Promise<void>;
// }

// const PromotionForm: React.FC<BranchPromotionFormProps> = ({ mode, initialData, onSubmit }) => {
//   const [loading, setLoading] = useState(false);
//   const navigate = useNavigate();

//   const form = useForm<BranchPromotionType>({
//     resolver: zodResolver(BranchPromotionSchema),
...
//   const handleFormSubmit = async (data: BranchPromotion) => {
//     setLoading(true);
//     try {
//       await onSubmit(data);
