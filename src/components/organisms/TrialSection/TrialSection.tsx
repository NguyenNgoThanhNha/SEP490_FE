...
const TrialSection: React.FC = () => {
  return (
    <div className="relative flex items-center justify-center overflow-hidden py-20 px-6 lg:px-10 bg-[#E8F8F5]">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-center w-full max-w-5xl mx-auto animate-fadeIn" style={{ animation: 'fadeIn 1.5s ease-out' }}>
        {/* Left Content Section */}
        <div className="lg:w-1/2 text-center lg:text-left mb-6 lg:mb-0 lg:pr-10">
          <h2 className="text-3xl font-bold text-[#130F49] mb-4">Welcome to Spa Center Solace</h2>
